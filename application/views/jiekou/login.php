...
<link rel="stylesheet" href="<?php echo $this->config->item('base_url');?>/public/login/css/normalize.css">
...
<div class="login">
    ...
    <div id="warningdiv" style="display:none">
	 ...
	 <form action="<?php echo $this->config->item('base_url');?>/jiekou/Login/loginIn" method="post" name="form1" id="form1">
...
function checkButton(){	
	...
	if(userName == '')
	{
		warning('<strong>错误：&nbsp;&nbsp;<font color="#993300">请输入用户名</font></strong>');return false;
	}
	/*if(userres.err == 0)
	{
	...
	dataType:'json',//从php返回的值以 JSON方式 解释
	async:false,
	data:{userPassword:userPassword , userName:userName},
	success: function(response)
	{//如果调用php成功
		res = response;
	}
